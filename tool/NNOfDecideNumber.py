...
if __name__ == "__main__":
    ...
    net = Network.FullConnectedNeuralNetwork([192, 100, 10])
    print('training begin!')
    net.train(trainData, testData, 100, 20, 0.4)
    print('training end!')
    net.save('..\\model\\NNOfDecideNumber\\' + time.strftime('%Y-%m-%d-%H-%M-%S', time.localtime()))
